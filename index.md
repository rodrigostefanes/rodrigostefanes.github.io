...
<p style="margin-left: 20px;">rodrigoamstefanes [at] gmail [dot] com</p>
...
<p>I have been working on <strong>automated program verification</strong>, with a particular focus on the formal validation of verification tools. I am also interested in <strong>model theory</strong>, especially in the context of non-classical logics. In addition, I enjoy contributing to broader <strong>computer science</strong> projects, such as the development of ranking and unranking algorithms.</p>
